...
**Specification:** [draft-arkavo-gguf-tdf-00](../../../gguf-tdf/draft-arkavo-gguf-tdf-00.md)
...
1. Create a new version directory (`draft-01/` or `1.0.0/` for release).
...
| Level 2 (Reader) | Level 1 + zip layout + GMAC/root-sig checks in the spec | Inference load path |
